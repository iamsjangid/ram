...
import { FaBoxOpen,FaBitcoin } from "react-icons/fa";
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 py-3.5 lg:py-4.5">
        <Link href="/" className="w-full items-center justify-center mx-auto">
          <Image
            width={176}
            height={32}
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        ...
                        Products
                        <TfiAngleDown className={`absolute right-4 top-1/2 -translate-y-1/2 text-lg fill-current ${open && "rotate-180"
                          }`} />
                      </Link>
                      {/* <!-- Dropdown Menu Start --> */}
                      <div
